            ...
            <div class="profile-layout">
                ...
                <div class="card">
                    <div style="padding:24px;text-align:center">
                        ...
                        <h3 style="margin:0 0 4px 0;font-size:18px">${user.fullName || user.username}</h3>
                        ...
                        <div style="margin-top:16px;padding:12px;background:#f8fafc;border-radius:8px;font-size:12px">
                            <div style="display:flex;justify-content:space-between;margin-bottom:8px">
                                ...
                                <code style="font-size:11px">${user.id?.slice(0,8) || 'N/A'}</code>
                            </div>
    ...
    editPersonalInfo() {
        ...
        window.ui.showModal('Edit Personal Information', `
            <div class="form-group">
                ...
                <input type="text" id="edit-fullname" class="fly-input" value="${user.fullName || ''}" placeholder="John Doe">
            </div>
            <div class="form-group">
                <label>Email</label>
                <input type="email" id="edit-email" class="fly-input" value="${user.email || ''}" placeholder="john@example.com">
            </div>
            <div class="form-row">
                <div class="form-group">
                    <label>Phone</label>
                    <input type="tel" id="edit-phone" class="fly-input" value="${user.phone || ''}" placeholder="+1234567890">
                </div>
                <div class="form-group">
                    <label>Country</label>
                    <input type="text" id="edit-country" class="fly-input" value="${user.country || ''}" placeholder="United States">
                </div>
            </div>
