    ...
    async renderProfitStats(container) {
        ...
        try {
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card"><div class="stat-card-label">Weekly Rate Multiplier</div><div class="stat-card-value" style="font-size:20px">${Number(rates.weekly).toFixed(2)}x</div></div>
                <div class="stat-card"><div class="stat-card-label">Monthly Rate Multiplier</div><div class="stat-card-value" style="font-size:20px">${Number(rates.monthly).toFixed(2)}x</div></div>
            </div>
            <div class="card">
