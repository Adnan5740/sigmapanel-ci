            ...
            <div class="card">
                ...
                <div class="table-wrapper">
                    <table class="fly-table">
                        <thead><tr><th>ID</th><th>Subject</th><th>Status</th><th>Created</th><th>Actions</th></tr></thead>
                        <tbody>
                            ${(tickets.data || []).map(t => `
                                <tr>
                            ...
                            `).join('')}
                            ${(tickets.data || []).length === 0 ? '<tr class="empty-row"><td colspan="5">No tickets</td></tr>' : ''}
                        </tbody>
                    </table>
                </div>
            </div>`;
        ...
        try {
            ...
            body.innerHTML = `
                <div style="margin-bottom:16px">
                    ...
                    <div style="padding:12px;background:#f8fafc;border-radius:8px">${window.ui.escapeHtml(ticket.message)}</div>
                </div>
