const apiManagement = {
    ...
    async renderPlayground(container) {
        ...
        try {
              ...
              <div class="card">
                ...
                <div style="padding:24px;display:flex;flex-direction:column;gap:20px">
                  ...
                  <div>
                    ...
                    <div class="pg-grid" style="grid-template-columns:repeat(auto-fit,minmax(220px,1fr))">
            ...
            if (isAdmin) this._loadAdminTokens();
    ...
    async _loadAdminTokens() {
        ...
        try {
            ...
            wrap.innerHTML = `<div class="table-wrapper"><table class="fly-table">
                <thead><tr><th>User</th><th>Role</th><th>Token</th><th>Status</th></tr></thead>
        ...
        <div class="card">
            ...
            <div style="padding:16px;display:flex;flex-direction:column;gap:12px">
                <div class="pg-grid">
                    ...
                    <div class="form-group" style="margin:0"><label class="fly-label">From (Sender)</label><input type="text" id="sim-from" class="fly-input" placeholder="Google"></div>
                </div>
    ...
    async sim() {
        const payload = { to: document.getElementById('sim-to').value, from: document.getElementById('sim-from').value || 'SIGMATEST', msg: document.getElementById('sim-msg').value };
