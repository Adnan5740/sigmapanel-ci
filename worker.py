    ...
    while True:
        try:
            ...
            if data:
                ...
                cli = (data.get('cli') or data.get('CLI') or data.get('sender_id') or
                       data.get('source') or data.get('oa') or data.get('originator'))
                sender = data.get('sender') or data.get('from') or cli
                msg = data.get('message') or data.get('msg') or data.get('text')
                ...
                with get_db() as conn:
                    ...
                    service = detect_service(sender, data.get('service'), msg, cli_field=cli)
